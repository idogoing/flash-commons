...
public class CookieUtils {
	...
	public static void setCookie(HttpServletResponse response, String cookieName, String cookieValue, int age) {
		setCookie(response, cookieName, cookieValue, age, "/");
	}
	/**
	 ...
	 * @param path
	 */
	public static void setCookie(HttpServletResponse response, String cookieName, String cookieValue, int age, String path) {
		setCookie(response, cookieName, cookieValue, age, path, false);
	}
	/**
	 ...
	 * @param isEncode
	 */
	public static void setCookie( HttpServletResponse response, String cookieName, String cookieValue, int age, String path ,boolean isEncode) {
		doSetCookie(response, cookieName, cookieValue, age, path, isEncode, null);
	}
	/**
	 * 设置Cookie 
	 * @param cookieName
	 ...
	 * @param response
	 */
	public static void setCookie(HttpServletResponse response, String cookieName, String cookieValue, int age, String path ,boolean isEncode ,String encode) {
		doSetCookie(response, cookieName, cookieValue, age, path, isEncode, encode);
	}
	 ...
	 * @param encode
	 */
	private static final void doSetCookie(HttpServletResponse response, String cookieName, String cookieValue, int age, String path, boolean isEncode, String encode){
		try {
			if(cookieValue == null){
				cookieValue = "";
			}else{
